...
if __name__ == "__main__":
    ...
    matrix_obj.add_service_to_room(gaming_room, my_quotes_1),

    matrix_obj.add_service_to_room(gaming_room, my_pendu) ;

    matrix_obj.add_service_to_room(admin_room, my_admin, "tbot admin install_from_list \
    ...
    # Start timer
    matrix_obj.add_timer_to_service(my_greeting);
